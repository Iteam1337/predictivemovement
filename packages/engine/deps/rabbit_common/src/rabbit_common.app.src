{application,rabbit_common,
             [{description,"Modules shared by rabbitmq-server and rabbitmq-erlang-client"},
              ...
              {modules,[app_utils,code_version,credit_flow,delegate,
                        ...
                        rabbit_data_coercion,rabbit_error_logger_handler,
                        rabbit_event,rabbit_exchange_type,
                        rabbit_framing_amqp_0_8,rabbit_framing_amqp_0_9_1,
                        rabbit_heartbeat,rabbit_http_util,rabbit_json,
                        rabbit_log,rabbit_log_ra_shim,rabbit_misc,
